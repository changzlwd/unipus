...
struct ConsumerIr : public IConsumerIr {
	...
	Return<int32_t> get_device_info() override;
	Return<int32_t> get_device_state() override;
	Return<int32_t> get_learn_code(const hidl_array<int32_t, 1024>& code) override;
	Return<int32_t> learnCmd(int32_t cmd) override;
