...
PRODUCT_BRAND := dianming
PRODUCT_MODEL := DMZX-AL30
PRODUCT_MANUFACTURER:= dianming
...
#hanzengqin porting from D60 for CTA
ifeq ($(TARGET_BUILD_CTA),true)
	PRODUCT_PROPERTY_OVERRIDES += \
			ro.unc.model_cta=true\
			persist.sys.model_cta=true
else
	PRODUCT_PROPERTY_OVERRIDES += \
			ro.unc.model_cta=false\
			persist.sys.model_cta=false
endif
#songtingting add for cta 20211115
ifeq ($(TARGET_BUILD_CTA),true)
$(shell cp frameworks/base/core/res/AndroidManifest_cta.xml frameworks/base/core/res/AndroidManifest.xml)
else
$(shell cp frameworks/base/core/res/AndroidManifest_normal.xml frameworks/base/core/res/AndroidManifest.xml)
endif
